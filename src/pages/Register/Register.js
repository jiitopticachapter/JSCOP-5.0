...
//       };
//       axios
//         .post("https://backend.jiitopticachapter.in/frontdata", Form)
//         .then(function () {
...
//                 IT
//               </option>
//               <option className="branch_dropdown" value="ECE">
//                 ECE
//               </option>
//               <option className="branch_dropdown" value="BIOTECHNOLOGY">
//                 BIOTECHNOLOGY
//               </option>
//               <option className="branch_dropdown" value="CSE_INT">
//                 CSE INTEGRATED
//               </option>
//               <option className="branch_dropdown" value="ECE_INT">
//                 ECE INTEGRATED
//               </option>
//               <option className="branch_dropdown" value="BBA">
//                 BBA
//               </option>
//               <option className="branch_dropdown" value="OTHER">
//                 OTHER
//               </option>
//             </select>
//             <br />
...
//               required
//             />
//             <label className="screenshot-label" htmlFor="screenshot">
//               <i
//                 className={`fa-solid ${
//                   uploaded === true ? "fa-check check-color" : "fa-circle"
//                 } file-tick`}
//               ></i>
//               {filename}
//             </label>
