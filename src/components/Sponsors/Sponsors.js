    ...
    <>
      <Heading title="Sponsors" size="5rem"/>
        ...
        <div className="Sponsors_slide">
          ...
          <div className="Sponsors_slide">
            <img src="https://cdn.icon-icons.com/icons2/2699/PNG/512/replit_logo_icon_168861.png" height="100" width="250" alt="SOLANA LOGO" />
          </div>
          <div className="Sponsors_slide">
            <img src="https://www.pngall.com/wp-content/uploads/10/Filecoin-Crypto-Logo-PNG-File.png" width="250" alt="POLYGON LOGO" />
          </div>
